...
@section('content')
    <div class="container-fluid">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                <form id="formCreate" action="{{ route('admin.item.store') }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    @csrf
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" name="cost_price" id="costPrice"
                                    ...
                                    placeholder="Masukkan harga modal" value="{{ old('cost_price') }}" required>
                            </div>
                            @error('cost_price')
                        ...
                        <div class="col-sm-10">
                            <div class="input-group">
                                ...
                                <input type="number" name="price" id="price"
                                    ...
                                    placeholder="Masukkan harga jual" value="{{ old('price') }}" required>
                            </div>
                            @error('price')
                                <small class="text-danger">
                                    {{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <div class="img-box-wrapper d-flex flex-wrap mb-1">
