                        ...
                        <tbody>
                            @forelse ($categories as $category)
                                <tr>
                                    ...
                                    <td><span
                                            class="{{ $category->is_active ? 'text-primary' : 'text-danger' }}">{{ $category->is_active ? 'Active' : 'Inactive' }}</span>
                                    </td>
                                    <td>
                                        <a href="{{ route('admin.category.edit', $category) }}" class="btn btn-sm btn-success mb-1" title="Edit"><i
